...
const preloadPath = () => path__default.join(__dirname, "../preload/preload.cjs");
const publicPath = () => process.env.VITE_PUBLIC ?? path__default.join(process.env.APP_ROOT ?? ".", "../public");
function createWindow() {
  const savedWindowInfo = settingsStore.get("window");
  win = new BrowserWindow({
    title: `${jiuyinGameModule.displayName}助手`,
    icon: path__default.join(publicPath(), "icon.png"),
